...
public class VistaEditarMateriaPrima extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setText("EDITAR MATERIA PRIMA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaEditarMateriaPrima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaEditarMateriaPrima().setVisible(true);
            }
        });
    }
